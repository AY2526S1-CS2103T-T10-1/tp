...
| `* * *`  | student                                   | view all details of a specific application using its index number                        | instantly recall information like job description link or my notes                               |
...
| `* * *`  | student                                   | see a unique index number for each application in the list view                          | easily reference them in update, view and delete commands                                        |
